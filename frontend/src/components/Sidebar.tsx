...
import {
  LayoutDashboard, Calendar, FileText, BarChart3, Megaphone,
  Share2, Bell, Settings, Sparkles, X, Zap,
} from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between px-5 h-16 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-bold text-gray-900 leading-none">SocialPilot</p>
              <p className="text-[10px] text-gray-500 mt-0.5">Campaign Manager</p>
            </div>
          </div>
              ...
              <li key={item.to}>
                ...
                >
                  {({ isActive }) => (
                    <>
                      <item.icon
                        className={cn('w-5 h-5 transition-colors', isActive ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-600')}
                      />
        ...
        <div className="p-3 border-t border-gray-200">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 p-4 text-white">
            ...
            <div className="relative">
              ...
              <p className="text-xs text-white/80 mb-3">Unlock advanced analytics & unlimited scheduling</p>
