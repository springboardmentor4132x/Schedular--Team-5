...
class BusinessAssignment(Base):
    ...
    __table_args__ = (
        UniqueConstraint("business_user_id", name="uq_business_user_single_team"),
    )
    ...
    def __repr__(self) -> str:
        return f"<BusinessAssignment business_user_id={self.business_user_id} marketing_team_id={self.marketing_team_id}>"