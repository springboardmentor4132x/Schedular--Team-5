...
class Post(Base):
    ...
    #
    # This stores the Supabase Storage location
    # of the user's uploaded image/video.
    #
    # The frontend does NOT ask the user to enter
    # a media URL.
    ...
    # Multiple uploaded images for carousel posts.
    #
    # Example:
    # [
    #     "uploaded-image-1",
    ...
    # ]
    #
    # These values are generated by our upload system,
